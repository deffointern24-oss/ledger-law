import { Phone, Mail, Search, User, X, ChevronDown, Settings, LogOut, Menu, ShoppingCart, Heart, } from "lucide-react";
...
const Header = () => {
  ...
  const handleLogout = () => {
    logout(); // This handles everything
    setIsProfileDropdownOpen(false);
    navigate("/");
  };
            ...
            {user ? (
              <div className="relative profile-dropdown">
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-4 w-4 text-gray-600 transition-transform ${isProfileDropdownOpen ? "rotate-180" : ""
                      }`}
                  />
                </button>
